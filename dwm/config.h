...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10:antialias=true:autohint=true", "Noto Sans CJK SC:size=10:antialias=true:autohint=true" };
...
/* tagging */
static const char *tags[] = { "", "", "", "", "󰂯", "󰢹", "7", "8" };
...
static const Rule rules[] = {
	...
	{ "Blueman-manager", NULL, NULL,    1 << 4,       1,           -1 },
	{ "Rustdesk",  NULL,       NULL,       1 << 5,       1,           -1 },
	{ "proj-airi-stage-tamagotchi", NULL, NULL, ~0,     1,           -1 },
};
